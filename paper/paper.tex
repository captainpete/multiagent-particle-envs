...
Compared to the \emph{anonymous} scenario, agents in the \emph{health} scenario were slower on average (see Figure \ref{fig:anon_health_compare}, plot 1).
...
However, clever dodging only worked in some instances.
We measured a drastic increase in average zombie reward (see Figure \ref{fig:anon_health_compare}, plot 2) due to zombies learning to immobilize and bite survivors.
In most cases, one survivor who would succumb to the zombies first, attracting the attention of most of the zombies and allowing the remaining survivor to stay out of harm's way.
